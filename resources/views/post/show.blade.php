    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-11 mb-3">
                ...
                @if ($post->url != '')
                <div class="mb-2">
                    <a href="{{ $post->url }}" target="_blank" class="link-secondary" rel="noopener noreferrer">{{
                        $post->url
                        }}</a>
                </div>
                @endif
                ...
                <div class="d-flex justify-content-start">
                    ...
                    <form action="{{ route('communities.post.destroy', [$post->community, $post]) }}" method="POST">
                        @csrf
                        @method('DELETE')
        ...
        <div class="row justify-content-end mb-4">
            <form class="col-md-11" method="POST" action="{{ route('posts.comment.store', $post) }}">
                @csrf
                <div class="mb-3">
                    <textarea class="form-control" name="comment_text" rows="2" placeholder="what are your thoughts?"
                        required></textarea>
                </div>
            ...
            <div class="col-11">
                ...
                <div class="border-start ps-4">
                    ...
                    <p><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>
                        <a href="#" class="link-secondary">likes</a> | <i class="fa fa-share" aria-hidden="true"></i>
